...
knitr::include_graphics('~/Documents/Masters/SpecialTopics/Olivia_Papiha_Midterm/images')
```
...
```
![Frequency of Weather Events](images/weather_categorical-2.png)
...
as.data.frame(rush_hours_wkend_tb)[1:10,]
```
...
as.data.frame(rush_hours_wkend2_tb)[1:10,]
```
