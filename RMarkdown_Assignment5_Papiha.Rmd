...
output %>% head(10) %>% dplyr::rename(Station = var)
```
...
output_2 %>% head(10) %>% dplyr::rename(Station = var)
```
...
as.data.frame(rush_hours2_tb[1:10]) %>% dplyr::rename(Station = Var1)
```
...
as.data.frame(rush_hours3_tb[1:10]) %>% dplyr::rename(Station = Var1)
```
...
as.data.frame(rush_hours_wkend_tb)[1:10,] %>% dplyr::rename(Station = Var1)
``` 
...
as.data.frame(rush_hours_wkend2_tb)[1:10,] %>% dplyr::rename(Station = Var1)
```
